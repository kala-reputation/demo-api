...
@javax.annotation.Generated(
    ...
    comments = "Source: demo/v1/demo.proto")
...
public final class DemoServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.demo.v1.GetDemoRequest,
      com.demo.v1.GetDemoResponse> getGetDemoMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetDemo",
      requestType = com.demo.v1.GetDemoRequest.class,
      responseType = com.demo.v1.GetDemoResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.demo.v1.GetDemoRequest,
      com.demo.v1.GetDemoResponse> getGetDemoMethod() {
    io.grpc.MethodDescriptor<com.demo.v1.GetDemoRequest, com.demo.v1.GetDemoResponse> getGetDemoMethod;
    if ((getGetDemoMethod = DemoServiceGrpc.getGetDemoMethod) == null) {
      synchronized (DemoServiceGrpc.class) {
        if ((getGetDemoMethod = DemoServiceGrpc.getGetDemoMethod) == null) {
          DemoServiceGrpc.getGetDemoMethod = getGetDemoMethod =
              io.grpc.MethodDescriptor.<com.demo.v1.GetDemoRequest, com.demo.v1.GetDemoResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetDemo"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.demo.v1.GetDemoRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.demo.v1.GetDemoResponse.getDefaultInstance()))
              .setSchemaDescriptor(new DemoServiceMethodDescriptorSupplier("GetDemo"))
              .build();
        }
      }
    }
    return getGetDemoMethod;
  }
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void getDemo(com.demo.v1.GetDemoRequest request,
        io.grpc.stub.StreamObserver<com.demo.v1.GetDemoResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getGetDemoMethod(), responseObserver);
    }
  }
  ...
  public static final class DemoServiceStub
    ...
    /**
     */
    public void getDemo(com.demo.v1.GetDemoRequest request,
        io.grpc.stub.StreamObserver<com.demo.v1.GetDemoResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getGetDemoMethod(), getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class DemoServiceBlockingStub
    ...
    /**
     */
    public com.demo.v1.GetDemoResponse getDemo(com.demo.v1.GetDemoRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
          getChannel(), getGetDemoMethod(), getCallOptions(), request);
    }
  }
  ...
  public static final class DemoServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.demo.v1.GetDemoResponse> getDemo(
        com.demo.v1.GetDemoRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
          getChannel().newCall(getGetDemoMethod(), getCallOptions()), request);
    }
  }

  private static final int METHODID_GET_DEMO = 0;
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_DEMO:
          serviceImpl.getDemo((com.demo.v1.GetDemoRequest) request,
              (io.grpc.stub.StreamObserver<com.demo.v1.GetDemoResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.demo.v1.GetDemoRequest,
              com.demo.v1.GetDemoResponse>(
                service, METHODID_GET_DEMO)))
        .build();
  }
  ...
  private static abstract class DemoServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.demo.v1.DemoProto.getDescriptor();
    }
